...
const country_info = {
  ...
  "Norway" : ["./CountryImages/Norway.jpg","I went to the capital of Oslo as it was the cheapest flight back into North America at the time, I was looking for flights. I spent three days there and saw the Munch art gallery and the Fram museum. While I did enjoy seeing the Edvard Munch’s artwork, particularly The Scream, I enjoyed the Fram museum more.","The picture is of me on a recreation of one of the boats that sailed through the northwest passage. The museum is dedicated to the history of Norwegian exploration of Greenland and the journey though the north west passage."],
